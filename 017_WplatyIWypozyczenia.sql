...
Uwaga
Jeśli w dwóch tabelach jest ta sama nazwa kolumny, SQL będzie wymagał podania, z której tabeli chcemy wyświetlić kolumnę (można używać aliasów), przykładowo:
